...
Welcome to my [personal website](https://humorousrr.github.io/personal-site/)! This is an [MIT licensed](https://github.com/HumorousRR/personal-site/blob/main/LICENSE) React-based Jamstack application. It offers a simple interface, easy modifications, static export capabilities, and free automatic deployments via [GitHub Pages](https://pages.github.com/).
